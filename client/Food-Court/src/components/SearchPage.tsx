...
const SearchPage = () => {
    ...
    const {loading,searchedRestaurant,searchRestaurant,appliedFilter ,setAppliedFilter} = useRestaurantStore();
        ...
        <div className="max-w-7xl my-10 mx-auto">
            <div className="flex flex-col md:flex-row justify-between gap-10  ">
                ...
                <div className="flex-1">
                    ...
                    <div>
                        <div className="flex flex-col md:flex-row gap-3 md:items-center my-3 md:gap-2">
                            <h2 className="text-lg font-medium">({searchedRestaurant?.data.length}) Search Result Found</h2>
                        ...
                        <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
                                ...
                                hover:shadow-2xl transition-shadow duration-300">
                                    <div className="relative">
                                        ...
                                        <div className="absolute top-2 left-2 bg-white dark:bg-gray-700 bg-opacity-75 
                                       px-3 rounded-lg py-1">
                                    ...
                                    <CardContent className="p-4">
                                        <h1 className="font-bold text-2xl text-gray-900
                                         dark:text-gray-100">{item.restaurantName} </h1>
                                         ...
                                         <div className="flex gap-2 items-center flex-wrap mt-4">
                                            {
                                                item.cuisines.map((cuisine:string, index:number)=>(
                                                    <Badge 
                                                    className="font-medium px-2 py-1 rounded-full shadow-md"
                                                    key={index}> {cuisine} </Badge>
                                                ))
                                            }
                                         </div>
                                    </CardContent>
                                    ...
                                    flex justify-end">
                                        <Link to={`/restaurant/${item._id}`}>
                                            <Button className="bg-blue-500 hover:bg-blue-600 py-2 px-4 font-semibold
                                            shadow-md rounded-full transition-colors duration-300">
                                            View Menu
                                            </Button>
                                        </Link>
                                    </CardFooter>
